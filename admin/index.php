                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form class="user" action="" method="post" id ="logform" novalidate>
                                        ...
                                        <div class="form-group">
                                            <input type="password" name="password" minlength="1" class="form-control form-control-user" id="exampleInputPassword" placeholder="Password" required >
